...
PARAM$semilla_primigenia <- 100057
PARAM$qsemillas <- 20
...
for (vmax_depth in c(1, 3, 5, 6, 7, 11, 12, 18)) {
  for (vmin_split in c(1100, 1000, 900, 800, 700, 600, 500, 400, 200, 100)) {
    for (cp_valor in c(-1)) {
      for (minbucket_valor in c(50, 100, 200, 300)) {
    ...
    param_basicos <- list(
      "cp" = cp_valor, # complejidad minima
      "maxdepth" = vmax_depth, # profundidad máxima del arbol
      "minsplit" = vmin_split, # tamaño minimo de nodo para hacer split
      "minbucket" = minbucket_valor # minima cantidad de registros en una hoja
    )
