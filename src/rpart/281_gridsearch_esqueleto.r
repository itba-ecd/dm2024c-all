...
PARAM$semilla_primigenia <- 105697
PARAM$qsemillas <- 20
...
# Defino los valores para cada hiperparámetro
cp_values <- c(-0.05, 0.01, 0.2, 0.7)
maxdepth_values <- c(4, 8, 10, 15)
minsplit_values <- c(100, 500, 2000, 5000 )
minbucket_values <- c(10, 30, 50, 200)
