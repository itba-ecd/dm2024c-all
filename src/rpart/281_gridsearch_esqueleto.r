...
PARAM$semilla_primigenia <- 199999
PARAM$qsemillas <- 20
...
for (vmax_depth in c(4, 6, 8, 10, 12, 14)) {
  for (vmin_split in c(1000, 800, 600, 400, 200, 100, 50)) {
    for (cp in c(0.1, -0.5, -1)) {
      for (minibucket in c(vmin_split/2, vmin_split/4, vmin_split/8)){
    ...
    param_basicos <- list(
      ...
      "minbucket" = minibucket # minima cantidad de registros en una hoja
    )
