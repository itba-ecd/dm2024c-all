...
PARAM$ranger <- list(
  "num.trees" = 500,       # Aumentado a 500 para mejorar la robustez
  "mtry" = 10,             # Ajustado a la raíz cuadrada del número total de atributos (ajusta según tu dataset)
  "min.node.size" = 20,    # Reducido para permitir más división de los nodos
  "max.depth" = 10,        # Mantener este valor, pero puedes experimentar
  "sample.fraction" = 0.8, # Muestreo de 80% de los datos para cada árbol
