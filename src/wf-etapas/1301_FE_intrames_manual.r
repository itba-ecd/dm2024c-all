...
AgregarVariables_IntraMes <- function(dataset) {
  ...
  # ctrx_quarter / mpayroll
  if( atributos_presentes( c("ctrx_quarter", "mpayroll") ))
    dataset[, ctrx_quarter_sobre_mpayroll := ctrx_quarter/mpayroll ]
  #mpayroll/Visa_cconsumos
  if( atributos_presentes( c("mpayroll", "Visa_cconsumos") ))
    dataset[, mpayroll_sobre_Visa_cconsumos := mpayroll / Visa_cconsumos]
  #Visa_cconsumos/ctarjeta_visa_transacciones
  if( atributos_presentes( c("Visa_cconsumos", "ctarjeta_visa_transacciones") ))
    dataset[, Visa_cconsumos_sobre_ctarjeta_visa_transacciones := Visa_cconsumos / ctarjeta_visa_transacciones]
  #mpayroll/mpasivos_margen
  if( atributos_presentes( c("mpayroll", "mpasivos_margen") ))
    dataset[, mpayroll_sobre_edad := mpayroll / mpasivos_margen]
