...
# #------------------------------------------------------------------------------
# 
# drift_CER <- function(campos_monetarios) {
#   cat( "inicio drift_CER()\n")
# 
#   dataset[tb_indices,
...
# #------------------------------------------------------------------------------
# 
# drift_IMUV <- function(campos_monetarios) {
#   cat( "inicio drift_IMUV()\n")
# 
#   dataset[tb_indices,
#           on = c(envg$PARAM$dataset_metadata$periodo),
#           (campos_monetarios) := .SD * i.IMUV,
#           .SDcols = campos_monetarios
#   ]
# 
#   cat( "fin drift_IMUV()\n")
# }
  ...
  # drift_IMA <- function(campos_monetarios) {
  #   cat( "inicio drift_IMA()\n")
  #   
  #   dataset[tb_indices,
  #           on = c(envg$PARAM$dataset_metadata$periodo),
  #           (campos_monetarios) := .SD * i.IMA,
  #           .SDcols = campos_monetarios
  #   ]
  #   
  #   cat( "fin drift_IMA()\n")
...
switch(envg$PARAM$metodo,
      ...
      #"IMUV" = drift_IMUV(campos_monetarios)
      #"IMA" = drift_IMA(campos_monetarios)
)
...
cat( "z1401_DR_corregir_drifting.r  END\n")
