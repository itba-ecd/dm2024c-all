...
PARAM$finalmodel$num_iterations <- 124
PARAM$finalmodel$learning_rate <- 0.0589707393375005
PARAM$finalmodel$feature_fraction <- 0.521802370913688
PARAM$finalmodel$min_data_in_leaf <- 1052
PARAM$finalmodel$num_leaves <- 134
PARAM$finalmodel$max_bin <- 31
PARAM$finalmodel$max_depth <- -1
PARAM$finalmodel$min_gain_to_split <- 0.0752490325460917
