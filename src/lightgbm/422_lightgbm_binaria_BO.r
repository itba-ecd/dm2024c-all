...
PARAM$hyperparametertuning$iteraciones <- 300 #más de 150
...
# no resulta pertinente colocar maxdepth porque estaría cortando LigthGBM
#Leaf-wise -> min_gain_to_split
#------------------------------------------------------------------------------
