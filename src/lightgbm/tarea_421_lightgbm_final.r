...
PARAM$finalmodel$num_iterations <- 117
PARAM$finalmodel$learning_rate <- 0.1231750784
PARAM$finalmodel$feature_fraction <- 0.100932631
PARAM$finalmodel$min_data_in_leaf <- 456
