...
PARAM$finalmodel$num_iterations <- 67
PARAM$finalmodel$learning_rate <- 0.073189183
PARAM$finalmodel$feature_fraction <- 0.837876618
PARAM$finalmodel$min_data_in_leaf <- 4354
