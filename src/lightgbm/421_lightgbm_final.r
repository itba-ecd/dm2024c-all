...
PARAM$finalmodel$num_iterations <- 251
PARAM$finalmodel$learning_rate <- 0.010091225
PARAM$finalmodel$feature_fraction <- 0.838834864
PARAM$finalmodel$min_data_in_leaf <- 747
PARAM$finalmodel$num_leaves <- 2944
PARAM$finalmodel$min_gain_to_split <- 0.056741
#PARAM$finalmodel$bagging_freq <- 7
#PARAM$finalmodel$bagging_fraction <- 0.923492
#PARAM$finalmodel$lambda_1 <- 0.74934
#PARAM$finalmodel$lambda_2 <- 0.986741
...
modelo <- lgb.train(
  ...
  param = list(
    ...
    #lambda_1 = PARAM$finalmodel$lambda_1,
    #lambda_2 = PARAM$finalmodel$lambda_2,
...
cortes <- seq(9000, 13500, by = 500) # maximo alrededor de 2000 en conceptual
