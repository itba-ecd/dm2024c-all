...
#   archivo  D:/Academico/ITBA/miAmbiente.yml
...
if( !file.exists( "D:/Academico/ITBA/miAmbiente.yml" ) )
  stop( "Error catastrofico, no existe el archivo D:/Academico/ITBA/miAmbiente.yml" )
...
if( !( miAmbiente$dataset_pequeno %in% c( "D:/Academico/ITBA/datasets/conceptual_dataset_pequeno.csv", "D:/Academico/ITBA/datasets/vivencial_dataset_pequeno.csv" )) )
  stop( "Error el campo dataset_pequeno solo puede tomar los valores  'D:/Academico/ITBA/datasets/conceptual_dataset_pequeno.csv', 'D:/Academico/ITBA/datasets/vivencial_dataset_pequeno.csv' " )

if( miAmbiente$modalidad == "conceptual" & miAmbiente$dataset_pequeno != "D:/Academico/ITBA/datasets/conceptual_dataset_pequeno.csv" )
  stop( "Error, Inconsistencia usted eligio la modalidad conceptual pero su dataset_pequeno NO es  'D:/Academico/ITBA/datasets/conceptual_dataset_pequeno.csv'" )

if( miAmbiente$modalidad == "vivencial" & miAmbiente$dataset_pequeno != "D:/Academico/ITBA/datasets/vivencial_dataset_pequeno.csv" )
  stop( "Error, Inconsistencia usted eligio la modalidad vivencial pero su dataset_pequeno NO es  'D:/Academico/ITBA/datasets/vivencial_dataset_pequeno.csv'" )
...
if( !( miAmbiente$dataset_competencia %in% c( "D:/Academico/ITBA/datasets/conceptual_competencia_2024.csv.gz", "D:/Academico/ITBA/datasets/vivencial_competencia_2024.csv.gz" )) )
  stop( "Error el campo dataset_competencia solo puede tomar los valores  'D:/Academico/ITBA/datasets/conceptual_competencia_2024.csv.gz', 'D:/Academico/ITBA/datasets/vivencial_competencia_2024.csv.gz'  " )

if( miAmbiente$modalidad == "conceptual" & miAmbiente$dataset_competencia != "D:/Academico/ITBA/datasets/conceptual_competencia_2024.csv.gz" )
  stop( "Error, Inconsistencia usted eligio la modalidad conceptual pero su dataset_competencia NO es  'D:/Academico/ITBA/datasets/conceptual_competencia_2024.csv.gz'" )

if( miAmbiente$modalidad == "vivencial" & miAmbiente$dataset_competencia != "D:/Academico/ITBA/datasets/vivencial_competencia_2024.csv.gz" )
  stop( "Error, Inconsistencia usted eligio la modalidad vivencial pero su dataset_competencia NO es  'D:/Academico/ITBA/datasets/vivencial_competencia_2024.csv.gz'" )
