...
#------------------------------------------------------------------------------
# Catastophe Analysis  Baseline   ----- ELEGIR METODO
# deterministico, SIN random
...
#  azaroso, utiliza semilla 
# COMENTARIOS:
#   3 MESES COMO TESTING  
#   SACAR 202003 O 202003+202004
#   DE ACUERDO AL METODO QUE USEMOS EN CA INCLUIR LOS MESES QUE ESTA SACANDO
#
#
#
