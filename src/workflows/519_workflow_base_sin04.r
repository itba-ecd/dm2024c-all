...
TS_strategy_base9 <- function( pinputexps )
{
  ...
  param_local$final_train$training <- c(202107, 202106, 202105, 202104, 202103, 202102,
    202101, 202012, 202011, 202010, 202009, 202008, 202007, 202006, 202005,202003, 202002)


  param_local$train$training <- c(202105, 202104, 202103, 202102, 202101,
    202012, 202011, 202010, 202009, 202008, 202007, 202006, 202005,202003,202002,202001,201912)
...
wf_septiembre <- function( pnombrewf )
{
  ...
  fm <- FM_final_models_lightgbm( c(ht, ts9), ranks=c(1), qsemillas=20 ) #cambiar cantidad de semillas
  SC_scoring( c(fm, ts9) )
  KA_evaluate_kaggle()
