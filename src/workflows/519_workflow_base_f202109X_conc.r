...
TS_strategy_base9 <- function( pinputexps )
{
  ...
  param_local$train$training <- c(202103, 202104,202103, 202102, 202101,202012, 202011, 202010,202009)
  param_local$train$validation <- c(202105)
...
wf_septiembre <- function( pnombrewf )
{
  ...
  fm <- FM_final_models_lightgbm( c(ht, ts9), ranks=c(1), qsemillas=25)
  SC_scoring( c(fm, ts9) )
  KA_evaluate_kaggle()
